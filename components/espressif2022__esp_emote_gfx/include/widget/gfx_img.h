...
/* JPEG image descriptor - for raw JPEG data */
typedef struct {
    gfx_image_header_t header;   /**< Image header (magic = 0xFFD8) */
    uint32_t data_size;         /**< Size of the JPEG data in bytes */
    const uint8_t * data;       /**< Pointer to raw JPEG data */
    const void * reserved;      /**< Reserved field for future use */
    const void * reserved_2;    /**< Reserved field for future use */
} gfx_jpeg_dsc_t;
